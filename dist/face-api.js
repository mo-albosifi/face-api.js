(function (global, factory) {
  ...
  var tfCore_esm = /*#__PURE__*/Object.freeze({
    ...
    Environment: o,
    KernelBackend: yo,
    MomentumOptimizer: md,
    Optimizer: ld,
    RMSPropOptimizer: gd,
    get Rank () { return bt; },
    get Reduction () { return ih; },
    SGDOptimizer: vd,
    Tensor: xt,
    TensorBuffer: vt,
    Variable: It,
    ...
    batchNorm3d: qu,
    batchNorm4d: Ku,
    batchNormalization: zu,
    batchNormalization2d: Wu,
    batchNormalization3d: Uu,
    batchNormalization4d: Vu,
    batchToSpaceND: dr,
    booleanMaskAsync: Pc,
    broadcastTo: pr,
    browser: Qf,
    ...
    sqrt: Du,
    square: Js,
    squaredDifference: gc,
    squaredDifferenceStrict: yc,
    squeeze: Or,
    stack: Mr,
    step: Tu,
    stft: oh,
  ...
  ***************************************************************************** */
  ...
  function isTensor(tensor, dim) {
      return tensor instanceof xt && tensor.shape.length === dim;
  }
  ...
  function normalize(x, meanRgb) {
      return Qe(function () {
          ...
          var avg_r = zn(__spreadArrays(x.shape.slice(0, 3), [1]), r);
          var avg_g = zn(__spreadArrays(x.shape.slice(0, 3), [1]), g);
          var avg_b = zn(__spreadArrays(x.shape.slice(0, 3), [1]), b);
          var avg_rgb = jn([avg_r, avg_g, avg_b], 3);
          return xc(x, avg_rgb);
      });
  }
  ...
  function padToSquare(imgTensor, isCenterImage) {
      ...
      return Qe(function () {
          ...
          var createPaddingTensor = function (paddingAmount) {
              ...
              return zn(paddingTensorShape, 0);
          };
          ...
          return jn(tensorsToStack, paddingAxis);
      });
  }
          ...
          return __generator(this, function (_b) {
              switch (_b.label) {
                  case 0:
                      ...
                      imgTensor3D = Qe(function () { return imgTensor.as3D(height, width, numChannels).toInt(); });
                      return [4 /*yield*/, Qf.toPixels(imgTensor3D, targetCanvas)];
                  case 1:
                      _b.sent();
                      imgTensor3D.dispose();
      ...
      NetInput.prototype.toBatchTensor = function (inputSize, isCenterInputs) {
          ...
          return Qe(function () {
              var inputTensors = range(_this.batchSize, 0, 1).map(function (batchIdx) {
                  ...
                  if (input instanceof xt) {
                      var imgTensor = isTensor4D(input) ? input : input.expandDims();
                      imgTensor = padToSquare(imgTensor, isCenterInputs);
                      if (imgTensor.shape[1] !== inputSize || imgTensor.shape[2] !== inputSize) {
                          imgTensor = Nh.resizeBilinear(imgTensor, [inputSize, inputSize]);
                      }
                      return imgTensor.as3D(inputSize, inputSize, 3);
                  }
                  if (input instanceof env.getEnv().Canvas) {
                      return Qf.fromPixels(imageToSquare(input, inputSize, isCenterInputs));
                  }
                  throw new Error("toBatchTensor - at batchIdx " + batchIdx + ", expected input to be instanceof tf.Tensor or instanceof HTMLCanvasElement, instead have " + input);
              });
              var batchTensor = Mr(inputTensors.map(function (t) { return t.toFloat(); })).as4D(_this.batchSize, inputSize, inputSize, 3);
              return batchTensor;
          });
      };
      return NetInput;
          ...
          return __generator(this, function (_a) {
              ...
              return [2 /*return*/, Qe(function () {
                      ...
                      var faceTensors = boxes.map(function (_a) {
                          var x = _a.x, y = _a.y, width = _a.width, height = _a.height;
                          return ml(imageTensor.as3D(imgHeight, imgWidth, numChannels), [y, x, 0], [height, width, numChannels]);
                      });
                      return faceTensors;
                  })];
          });
      ...
      return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (_b) {
              switch (_b.label) {
                  ...
                  case 1:
                      manifest = _b.sent();
                      return [2 /*return*/, Kf.loadWeights(manifest, modelBaseUri)];
              }
          });
      });
  }
  ...
  var NeuralNetwork = /** @class */ (function () {
      ...
      NeuralNetwork.prototype.getTrainableParams = function () {
          return this.getParamList().filter(function (param) { return param.tensor instanceof It; });
      };
      ...
      NeuralNetwork.prototype.freeze = function () {
          ...
          this.getTrainableParams().forEach(function (_a) {
              ...
              var tensor = Tn(variable.dataSync());
              variable.dispose();
              ...
              return __generator(this, function (_d) {
                  switch (_d.label) {
                      case 0:
                          ...
                          loadWeights = Kf.weightsLoaderFactory(fetchWeightsFromDisk);
                          _c = (_b = JSON).parse;
      ...
      NeuralNetwork.prototype.traversePropertyPath = function (paramPath) {
          ...
          if (!obj || !objProp || !(obj[objProp] instanceof xt)) {
  ...
  function depthwiseSeparableConv(x, params, stride) {
      return Qe(function () {
          var out = $c(x, params.depthwise_filter, params.pointwise_filter, stride, 'same');
          out = Zu(out, params.bias);
          return out;
      });
  }
  ...
  function denseBlock4(x, denseBlockParams, isFirstLayer, isScaleDown) {
      ...
      return Qe(function () {
          var out1 = _l(isFirstLayer
              ? Zu(zc(x, denseBlockParams.conv0.filters, isScaleDown ? [2, 2] : [1, 1], 'same'), denseBlockParams.conv0.bias)
              : depthwiseSeparableConv(x, denseBlockParams.conv0, isScaleDown ? [2, 2] : [1, 1]));
          var out2 = depthwiseSeparableConv(out1, denseBlockParams.conv1, [1, 1]);
          var in3 = _l(Zu(out1, out2));
          var out3 = depthwiseSeparableConv(in3, denseBlockParams.conv2, [1, 1]);
          var in4 = _l(Zu(out1, Zu(out2, out3)));
          var out4 = depthwiseSeparableConv(in4, denseBlockParams.conv3, [1, 1]);
          return _l(Zu(out1, Zu(out2, Zu(out3, out4))));
      });
  }
  ...
  function convLayer(x, params, padding, withRelu) {
      ...
      return Qe(function () {
          var out = Zu(zc(x, params.filters, [1, 1], padding), params.bias);
          return withRelu ? _l(out) : out;
      });
  }
  ...
  function extractConvParamsFactory(extractWeights, paramMappings) {
      return function (channelsIn, channelsOut, filterSize, mappedPrefix) {
          var filters = Bn(extractWeights(channelsIn * channelsOut * filterSize * filterSize), [filterSize, filterSize, channelsIn, channelsOut]);
          var bias = _n(extractWeights(channelsOut));
  ...
  function extractFCParamsFactory(extractWeights, paramMappings) {
      return function (channelsIn, channelsOut, mappedPrefix) {
          var fc_weights = On(extractWeights(channelsIn * channelsOut), [channelsIn, channelsOut]);
          var fc_bias = _n(extractWeights(channelsOut));
  ...
  function extractSeparableConvParamsFactory(extractWeights, paramMappings) {
      return function (channelsIn, channelsOut, mappedPrefix) {
          var depthwise_filter = Bn(extractWeights(3 * 3 * channelsIn), [3, 3, channelsIn, 1]);
          var pointwise_filter = Bn(extractWeights(channelsIn * channelsOut), [1, 1, channelsIn, channelsOut]);
          var bias = _n(extractWeights(channelsOut));
  ...
  var FaceFeatureExtractor = /** @class */ (function (_super) {
      ...
      FaceFeatureExtractor.prototype.forwardInput = function (input) {
          ...
          return Qe(function () {
              ...
              var normalized = normalize(batchTensor, meanRgb).div(Fn(255));
              var out = denseBlock4(normalized, params.dense0, true);
              out = denseBlock4(out, params.dense1);
              out = denseBlock4(out, params.dense2);
              out = denseBlock4(out, params.dense3);
              out = cl(out, [7, 7], [2, 2], 'valid');
              return out;
          });
      };
  ...
  function fullyConnectedLayer(x, params) {
      return Qe(function () {
          return Zu(Jc(x, params.weights), params.bias);
      });
  }
  ...
  var FaceExpressionNet = /** @class */ (function (_super) {
      ...
      FaceExpressionNet.prototype.forwardInput = function (input) {
          var _this = this;
          return Qe(function () { return vo(_this.runNet(input)); });
      };
          ...
          return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      ...
                      case 2:
                          out = _a.sent();
                          return [4 /*yield*/, Promise.all(Lr(out).map(function (t) { return __awaiter(_this, void 0, void 0, function () {
                                  var data;
                                  return __generator(this, function (_a) {
                                      switch (_a.label) {
  ...
  function conv(x, params, stride) {
      return Zu(zc(x, params.filters, stride, 'same'), params.bias);
  }
  function reductionBlock(x, params, isActivateInput) {
      if (isActivateInput === void 0) { isActivateInput = true; }
      var out = isActivateInput ? _l(x) : x;
      out = depthwiseSeparableConv(out, params.separable_conv0, [1, 1]);
      out = depthwiseSeparableConv(_l(out), params.separable_conv1, [1, 1]);
      out = ul(out, [3, 3], [2, 2], 'same');
      out = Zu(out, conv(x, params.expansion_conv, [2, 2]));
      return out;
  }
  function mainBlock(x, params) {
      var out = depthwiseSeparableConv(_l(x), params.separable_conv0, [1, 1]);
      out = depthwiseSeparableConv(_l(out), params.separable_conv1, [1, 1]);
      out = depthwiseSeparableConv(_l(out), params.separable_conv2, [1, 1]);
      out = Zu(out, x);
      return out;
  }
  var TinyXception = /** @class */ (function (_super) {
      ...
      TinyXception.prototype.forwardInput = function (input) {
          ...
          return Qe(function () {
              var batchTensor = input.toBatchTensor(112, true);
              var meanRgb = [122.782, 117.001, 104.298];
              var normalized = normalize(batchTensor, meanRgb).div(Fn(256));
              var out = _l(conv(normalized, params.entry_flow.conv_in, [2, 2]));
              ...
              out = _l(depthwiseSeparableConv(out, params.exit_flow.separable_conv, [1, 1]));
              return out;
          });
      };
  ...
  var AgeGenderNet = /** @class */ (function (_super) {
      ...
      AgeGenderNet.prototype.runNet = function (input) {
          ...
          return Qe(function () {
              var bottleneckFeatures = input instanceof NetInput
                  ? _this.faceFeatureExtractor.forwardInput(input)
                  : input;
              var pooled = cl(bottleneckFeatures, [7, 7], [2, 2], 'valid').as2D(bottleneckFeatures.shape[0], -1);
      ...
      AgeGenderNet.prototype.forwardInput = function (input) {
          ...
          return Qe(function () {
              ...
              return { age: age, gender: vo(gender) };
          });
      };
      ...
      FaceLandmark68NetBase.prototype.postProcess = function (output, inputSize, originalDimensions) {
          ...
          return Qe(function () {
              ...
              var landmarkTensors = output
                  .mul(zn([batchSize, 136], inputSize))
                  .sub(Mr(Array.from(Array(batchSize), function (_, batchIdx) {
                  return createInterleavedTensor(getPaddingX(batchIdx), getPaddingY(batchIdx));
              })))
                  .div(Mr(Array.from(Array(batchSize), function (_, batchIdx) {
          ...
          return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      ...
                      case 1:
                          netInput = _a.sent();
                          landmarkTensors = Qe(function () { return Lr(_this.forwardInput(netInput)); });
  ...
  function extractorsFactory$2(extractWeights, paramMappings) {
      function extractFilterValues(numFilterValues, numFilters, filterSize) {
          ...
          return Qe(function () { return Bl(Bn(weights, [numFilters, depth, filterSize, filterSize]), [2, 3, 1, 0]); });
      }
      function extractConvParams(numFilterValues, numFilters, filterSize, mappedPrefix) {
          var filters = extractFilterValues(numFilterValues, numFilters, filterSize);
          var bias = _n(extractWeights(numFilters));
          paramMappings.push({ paramPath: mappedPrefix + "/filters" }, { paramPath: mappedPrefix + "/bias" });
          return { filters: filters, bias: bias };
      }
      function extractScaleLayerParams(numWeights, mappedPrefix) {
          var weights = _n(extractWeights(numWeights));
          var biases = _n(extractWeights(numWeights));
  ...
  function extractParams$4(weights) {
      ...
      var fc = Qe(function () { return Bl(On(extractWeights(256 * 128), [128, 256]), [1, 0]); });
  ...
  function residualDown(x, params) {
      ...
      out = convNoRelu(out, params.conv2);
      var pooled = cl(x, 2, 2, 'valid');
      var zeros = Vn(pooled.shape);
      var isPad = pooled.shape[3] !== out.shape[3];
      var isAdjustShape = pooled.shape[1] !== out.shape[1] || pooled.shape[2] !== out.shape[2];
      if (isAdjustShape) {
          var padShapeX = __spreadArrays(out.shape);
          padShapeX[1] = 1;
          var zerosW = Vn(padShapeX);
          out = jn([out, zerosW], 1);
          var padShapeY = __spreadArrays(out.shape);
          padShapeY[2] = 1;
          var zerosH = Vn(padShapeY);
          out = jn([out, zerosH], 2);
      }
      pooled = isPad ? jn([pooled, zeros], 3) : pooled;
      out = Zu(pooled, out);
      out = _l(out);
      return out;
  }
  ...
  var FaceRecognitionNet = /** @class */ (function (_super) {
      ...
      FaceRecognitionNet.prototype.forwardInput = function (input) {
          ...
          return Qe(function () {
              ...
              var fullyConnected = Jc(globalAvg, params.fc);
          ...
          return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      ...
                      case 1:
                          netInput = _a.sent();
                          faceDescriptorTensors = Qe(function () { return Lr(_this.forwardInput(netInput)); });
  ...
  function extractorsFactory$4(extractWeights, paramMappings) {
      function extractDepthwiseConvParams(numChannels, mappedPrefix) {
          var filters = Bn(extractWeights(3 * 3 * numChannels), [3, 3, numChannels, 1]);
          var batch_norm_scale = _n(extractWeights(numChannels));
          var batch_norm_offset = _n(extractWeights(numChannels));
          var batch_norm_mean = _n(extractWeights(numChannels));
          var batch_norm_variance = _n(extractWeights(numChannels));
  ...
  function extractParams$5(weights) {
      ...
      var extra_dim = Mn(extractWeights(5118 * 4), [1, 5118, 4]);
      var output_layer = {
          extra_dim: extra_dim
      };
  ...
  function pointwiseConvLayer(x, params, strides) {
      return Qe(function () {
          var out = zc(x, params.filters, strides, 'same');
          out = Zu(out, params.batch_norm_offset);
          return su(out, 0, 6);
      });
  }
  ...
  function depthwiseConvLayer(x, params, strides) {
      return Qe(function () {
          var out = Kc(x, params.filters, strides, 'same');
          out = Gu(out, params.batch_norm_mean, params.batch_norm_variance, params.batch_norm_offset, params.batch_norm_scale, epsilon);
          return su(out, 0, 6);
      });
  }
  ...
  function getCenterCoordinatesAndSizesLayer(x) {
      ...
      var centers = [
          Zu(vec[0], rc(sizes[0], Fn(2))),
          Zu(vec[1], rc(sizes[1], Fn(2)))
      ];
      return {
          sizes: sizes,
          centers: centers
  ...
  function decodeBoxesLayer(x0, x1) {
      ...
      var vec = Lr(Bl(x1, [1, 0]));
      var div0_out = rc(dc(hu(rc(vec[2], Fn(5))), sizes[0]), Fn(2));
      var add0_out = Zu(dc(rc(vec[0], Fn(10)), sizes[0]), centers[0]);
      var div1_out = rc(dc(hu(rc(vec[3], Fn(5))), sizes[1]), Fn(2));
      var add1_out = Zu(dc(rc(vec[1], Fn(10)), sizes[1]), centers[1]);
      return Bl(Mr([
          xc(add0_out, div0_out),
          xc(add1_out, div1_out),
          Zu(add0_out, div0_out),
          Zu(add1_out, div1_out)
      ]), [1, 0]);
  }
  function outputLayer(boxPredictions, classPredictions, params) {
      return Qe(function () {
          var batchSize = boxPredictions.shape[0];
          var boxes = decodeBoxesLayer(Fr(Br(params.extra_dim, [batchSize, 1, 1]), [-1, 4]), Fr(boxPredictions, [-1, 4]));
          boxes = Fr(boxes, [batchSize, (boxes.shape[0] / batchSize), 4]);
          var scoresAndClasses = wu(dl(classPredictions, [0, 0, 1], [-1, -1, -1]));
          var scores = dl(scoresAndClasses, [0, 0, 0], [-1, -1, 1]);
          scores = Fr(scores, [batchSize, scores.shape[1]]);
          var boxesByBatch = Lr(boxes);
          var scoresByBatch = Lr(scores);
          return {
              boxes: boxesByBatch,
  ...
  function boxPredictionLayer(x, params) {
      return Qe(function () {
          ...
          var boxPredictionEncoding = Fr(convLayer(x, params.box_encoding_predictor), [batchSize, -1, 1, 4]);
          var classPrediction = Fr(convLayer(x, params.class_predictor), [batchSize, -1, 3]);
          return {
  ...
  var SsdMobilenetv1 = /** @class */ (function (_super) {
      ...
      SsdMobilenetv1.prototype.forwardInput = function (input) {
          ...
          return Qe(function () {
              ...
              var x = xc(dc(batchTensor, Fn(0.007843137718737125)), Fn(1));
  ...
  function leaky(x) {
      return Qe(function () {
          var min = dc(x, Fn(0.10000000149011612));
          return Zu(_l(xc(x, min)), min);
  ...
  function convWithBatchNorm(x, params) {
      return Qe(function () {
          var out = Er(x, [[0, 0], [1, 1], [1, 1], [0, 0]]);
          out = zc(out, params.conv.filters, [1, 1], 'valid');
          out = xc(out, params.bn.sub);
          out = dc(out, params.bn.truediv);
          out = Zu(out, params.conv.bias);
          return leaky(out);
      });
  }
  ...
  function depthwiseSeparableConv$1(x, params) {
      return Qe(function () {
          var out = Er(x, [[0, 0], [1, 1], [1, 1], [0, 0]]);
          out = $c(out, params.depthwise_filter, params.pointwise_filter, [1, 1], 'valid');
          out = Zu(out, params.bias);
          return leaky(out);
      });
  }
  ...
  function extractorsFactory$6(extractWeights, paramMappings) {
      ...
      function extractBatchNormParams(size, mappedPrefix) {
          var sub = _n(extractWeights(size));
          var truediv = _n(extractWeights(size));
      ...
      TinyYolov2Base.prototype.forwardInput = function (input, inputSize) {
          ...
          return Qe(function () {
              ...
              batchTensor = _this.config.meanRgb
                  ...
                  : batchTensor;
              batchTensor = batchTensor.div(Fn(256));
          ...
          return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, function (_b) {
                  switch (_b.label) {
                      ...
                      case 2:
                          out = _b.sent();
                          out0 = Qe(function () { return Lr(out)[0].expandDims(); });
                          inputDimensions = {
                              width: netInput.getInputWidth(0),
                              height: netInput.getInputHeight(0)
                          };
                      ...
                      case 0:
                          ...
                          _a = Qe(function () {
                              ...
                              var classScores = _this.withClassScores
                                  ? vo(reshaped.slice([0, 0, 0, 5], [numCells, numCells, numBoxes, _this.config.classes.length]), 3)
                                  : Fn(0);
          ...
          return __generator(this, function (_c) {
              switch (_c.label) {
                  case 0:
                      ...
                      if (!(input instanceof xt)) return [3 /*break*/, 2];
                  ...
                  case 6:
                      results = _c.sent();
                      faces.forEach(function (f) { return f instanceof xt && f.dispose(); });
                      return [2 /*return*/, results];
              }
          });
      });
  ...
  function bgrToRgbTensor(tensor) {
      return Qe(function () { return Mr(Lr(tensor, 3).reverse(), 3); });
  }
  ...
  function extractorsFactory$8(extractWeights, paramMappings) {
      ...
      function extractPReluParams(size, paramPath) {
          var alpha = _n(extractWeights(size));
  ...
  function normalize$1(x) {
      return Qe(function () { return dc(xc(x, Fn(127.5)), Fn(0.0078125)); });
  }

  function prelu(x, alpha) {
      return Qe(function () {
          return Zu(_l(x), dc(alpha, gu(_l(gu(x)))));
      });
  }
  ...
  function sharedLayer(x, params, isPnet) {
      ...
      return Qe(function () {
          ...
          out = ul(out, isPnet ? [2, 2] : [3, 3], [2, 2], 'same');
          out = convLayer(out, params.conv2, 'valid');
          out = prelu(out, params.prelu2_alpha);
          out = isPnet ? out : ul(out, [3, 3], [2, 2], 'valid');
  ...
  function PNet(x, params) {
      return Qe(function () {
          ...
          var max = xr(Rl(conv, 3), 3);
          var prob = vo(xc(conv, max), 3);
  ...
  function rescaleAndNormalize(x, scale) {
      return Qe(function () {
          ...
          var resized = Nh.resizeBilinear(x, [height, width]);
          var normalized = normalize$1(resized);
          return Bl(normalized, [0, 2, 1, 3]);
      });
  }
  ...
  function stage1(imgTensor, scales, scoreThreshold, params, stats) {
      stats.stage1 = [];
      var pnetOutputs = scales.map(function (scale) { return Qe(function () {
          ...
          var scoresTensor = Lr(Lr(prob, 3)[1])[0];
          var regionsTensor = Lr(regions)[0];
          return {
              ...
              switch (_b.label) {
                  ...
                  case 1:
                      ...
                      return [2 /*return*/, imagePatchesDatas.map(function (data) {
                              var t = Qe(function () {
                                  var imagePatchTensor = Bl(Bn(data, [1, width, height, 3]), [0, 2, 1, 3]).toFloat();
  ...
  function RNet(x, params) {
      return Qe(function () {
          ...
          var vectorized = Fr(convOut, [convOut.shape[0], params.fc1.weights.shape[0]]);
          ...
          var max = xr(Rl(fc2_1, 1), 1);
          var prob = vo(xc(fc2_1, max), 1);
          var regions = fullyConnectedLayer(prelu4, params.fc2_2);
          var scores = Lr(prob, 1)[1];
              ...
              switch (_c.label) {
                  ...
                  case 1:
                      ...
                      scoresTensor = rnetOuts.length > 1
                          ? jn(rnetOuts.map(function (out) { return out.scores; }))
                          : rnetOuts[0].scores;
                      _b = (_a = Array).from;
  ...
  function ONet(x, params) {
      return Qe(function () {
          ...
          var vectorized = Fr(out, [out.shape[0], params.fc1.weights.shape[0]]);
          var fc1 = fullyConnectedLayer(vectorized, params.fc1);
              ...
              switch (_c.label) {
                  ...
                  case 1:
                      ...
                      scoresTensor = onetOuts.length > 1
                          ? jn(onetOuts.map(function (out) { return out.scores; }))
                          : onetOuts[0].scores;
                      _b = (_a = Array).from;
                      return [4 /*yield*/, scoresTensor.data()];
                  case 2:
              ...
              return __generator(this, function (_c) {
                  switch (_c.label) {
                      case 0:
                          ...
                          stats = {};
                          tsTotal = Date.now();
                          imgTensor = Qe(function () {
                              return bgrToRgbTensor(xr(Qf.fromPixels(inputCanvas)).toFloat());
                          });
              ...
              return __generator(this, function (_b) {
                  switch (_b.label) {
                      ...
                      case 1:
                          ...
                          if (!(this.input instanceof xt)) return [3 /*break*/, 3];
